...
Parkour.GameState = {
    ...
    update: function() {
       ...
       // this.game.physics.arcade.collide(this.player, this.trampoline2, this.hitTramp, null, this);
        ...
        if (this.cursors.left.isDown || this.player.customParams.isMovingLeft) {
            ...
            this.player.scale.setTo(1, 1);
            this.player.play("player");
        } else if(this.cursors.up.isDown && this.player.body.y > 350 || this.player.customParams.isMovingUp && this.player.body.y > 350){
            this.player.body.velocity.y = -this.RUNNING_SPEED;
            this.player.play("player");
        }
          else if(this.cursors.down.isDown || this.player.left.isMovingDown){
            this.player.body.velocity.y = this.RUNNING_SPEED;
            this.player.play("player");
        }
        else {
        ...
        //left up diagonal movement
         if(this.cursors.up.isDown && this.cursors.left.isDown && this.player.body.y > 350){
            this.player.body.velocity.y = -this.RUNNING_SPEED;
            this.player.body.velocity.x = -this.RUNNING_SPEED;
            this.player.play("player");
        }
        //right up diagonal movement
        else if(this.cursors.up.isDown && this.cursors.right.isDown && this.player.body.y > 350){
            this.player.body.velocity.y = -this.RUNNING_SPEED;
            this.player.body.velocity.x = this.RUNNING_SPEED;
            this.player.play("player");
        }
    ...
    createOnscreenControls: function() {
        ...
        this.upArrow = this.add.button(50, this.game.height - 140, 'arrowButton');
        this.downArrow = this.add.button(150, this.game.height - 40, 'arrowButton');
        ...
        this.upArrow.alpha = 0.7;
        this.downArrow.alpha = 0.7;
        ...
        this.upArrow.events.onInputDown.add(function() {
            this.player.customParams.isMovingUp = true;
        }, this);

        this.upArrow.events.onInputUp.add(function() {
            this.player.customParams.isMovingUp = false;
        }, this);
        ...
        this.downArrow.events.onInputDown.add(function() {
            this.player.customParams.isMovingDown = true;
        }, this);

        this.downArrow.events.onInputUp.add(function() {
            this.player.customParams.isMovingDown = false;
        }, this);
